...
`
Write me a list of side effects for a the food below. Make sure to be very scientific citing researches and real life examples.
...
const generateAction = async (req, res) => {
  ...
  Side Effects: ${basePromptOutput.text}
